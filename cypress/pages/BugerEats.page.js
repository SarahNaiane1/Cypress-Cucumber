...
const modalText = 'Recebemos os seus dados. Fique de olho na sua caixa de email, pois e em breve retornamos o contato.';
...
class HomePage {
  ...
  clickButton(){
    ...
    fillData() {
        ...
        .type(deliver.individualTaxpayerRegistration)
    ...
    FillAdress(){
        ...
        .type(deliver.address.complement)
   ...
   */
    ...
    individualTaxpayerRegistrationDisable(){     
      ...
      cy.get('input[name="cpf"]')
      .type(deliver.individualTaxpayerRegistrationDisable)
